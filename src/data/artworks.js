export const artworks = [
  ...
  // Poster Colour Category
  {
    id: "poster-colour-01",
    title: "Shiny Leafs",
    description: "A premium poster colour painting showcasing detailed green leaves covered with water droplets, highlights, and fine organic veins.",
    category: "poster-colour",
    image: "/src/assets/artworks/poster-colour/shiny-leafs.jpg",
    detailImage: "/src/assets/artworks/poster-colour/shiny-leafs-detail.jpg",
  ...
  // Pencil Shading Category
  {
    ...
    title: "Rope Study",
    description: "A highly detailed graphite pencil shading drawing of intertwined heavy ropes, exploring tones, values, and organic textures.",
    category: "pencil-shading",
    image: "/src/assets/artworks/pencil-shading/rope-study.jpg",
    detailImage: "/src/assets/artworks/pencil-shading/rope-study-detail.jpg",
  ...
  // Reverse Painting Category
  {
    ...
    image: "/src/assets/artworks/reverse-painting/reverse-painting.jpg",
    detailImage: "/src/assets/artworks/reverse-painting/reverse-painting-detail.jpg",
    medium: "Acrylic (Reverse Painting)",
    year: "2025",
    dimensions: "A4",
    price: "",
    featured: true
